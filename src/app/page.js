...
export default function Home() {
  ...
  useEffect(() => {
    if (transactions.length > 0) {
      ...
      const totalInvestedAmount = buyTransactions.reduce((sum, t) => sum + parseFloat(t.fiat_amount), 0);
      const totalBitcoinAmount = buyTransactions.reduce((sum, t) => sum + parseFloat(t.crypto_amount), 0);
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="text-muted-foreground">Gestion des transactions et comptes</p>
          </div>
          <Button 
            variant="outline" 
